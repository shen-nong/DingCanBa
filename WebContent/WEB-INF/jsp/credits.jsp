...
<div class="wrapper">
    ...
    <div class="section_container">
        ...
        <section>
            <ul class="breadcrumb">
                <li><a>精品零食</a></li>
                <li class="active"><a href="find.html?id=0" >肉食主义</a></li>
                <li class="active"><a href="find.html?id=1">休闲零食</a></li>
                <li class="active"><a href="find.html?id=2">时尚饮品</a></li>
                <li class="active"><a href="find.html?id=3">饼干糕点</a></li>
                <li class="active"><a href="find.html?id=4">糖果巧克力</a></li>
            </ul>
            <ul class="breadcrumb">
                <li><a>日常必备</a></li>
                <li class="active"><a href="find.html?id=7">洗发沐浴</a></li>
                <li class="active"><a href="find.html?id=9">个人护理</a></li>
                <li class="active"><a href="find.html?id=11">家居清洁</a></li>
                <li class="active"><a href="find.html?id=10">湿巾卫生纸</a></li>
                <li class="active"><a href="find.html?id=8">衣物清洁用品</a></li>
            </ul>
            <ul class="breadcrumb">
                <li><a>生活用品</a></li>
                <li class="active"><a href="find.html?id=5">体育娱乐</a></li>
                <li class="active"><a href="find.html?id=6">烹饪必备</a></li>
                <li class="active"><a href="find.html?id=12">玩具</a></li>
            </ul>
<div class="demo clearfix">
	<div class="item_list infinite_scroll">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="product.html?id=${message.toId }"><img width="210" height="240" alt="${message.contentText }" src="${message.pictureUrl }" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
						<a onclick="addCart(${message.toId })" class="img_album_btn">加入餐车</a>
					</div>
				</div>
				<div class="title"><span>${message.contentText }</span></div>
			</div>
			<div class="item_b clearfix">
				...
				<div class="items_comment fr"><a onclick="buyNow(${message.toId })">立即购买</a><em class="bold">(24)</em></div>
			</div>
		</div><!--item end-->			
		</c:forEach>
	</div>
