...
<div class="wrapper">
    ...
    <div class="navigation_container">
		...
		<c:import url="/navigation.html" charEncoding="UTF-8">
			<c:param name="type" value="shop"></c:param>
		</c:import>
        <!--Navigation Ends-->
    </div>
    <div class="section_container">
        ...
        <section>
            <ul class="breadcrumb">
                <li><a>商家排序方式</a></li>
                <li class="active"><a href="shopList.html?sort=sum">按店里商品的数量</a></li>
                <li class="active"><a href="shopList.html?sort=sale">按本月的销售量</a></li>
            </ul>
                        <ul class="breadcrumb">
                <li><a>外卖分类查看</a></li>
...
<div class="demo clearfix">
	<div class="item_list infinite_scroll">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="shop.html?id=${shop.shop.shopId }"><img width="210" height="240" alt="${shop.shop.shopName }" src="${shop.shop.signboardUrl }" /></a>
					<span class="price">营业额 ￥${shop.turnover}</span>
					<div class="btns">
						<a onclick="addCollection(${shop.shop.shopId })" class="img_album_btn">加入收藏</a>
					</div>
				</div>
				<div class="title"><span color=red>${shop.shop.shopName }</span><br>${shop.shop.shopDescription }</div>
			</div>
			<div class="item_b clearfix">
				...
				<div class="items_comment fr"><a href="shop.html?id=${shop.shop.shopId }">去看看</a><em class="bold">(${shop.view})</em></div>
			</div>
		</div><!--item end-->			
		</c:forEach>
	</div>
	...
	<div id="more"><a href="shopList/2.html?sort=${sort }"></a></div>
